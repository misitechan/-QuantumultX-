...
## 1️⃣QuantumultX 自用配置：
* 配置更新时间：2024-05-21
* 自用QX配置 [***Cuttlefish.conf***](https://github.com/misitechan/Profile-gather/blob/main/misitechan.conf) 
...
* 更多懒人配置请狠狠的 [***Click me***](https://github.com/misitechan/Profile-gather)
